...
table_names = ['on_time_stats','aircarrier_stats']
attributes = ['ORIGIN_AIRPORT_ID', 'ORIGIN_AIRPORT_ID']
number_of_samples = 200
attribute_indices = [4,3]
method = 'correlated'
sampling_probabilities = [.01, .05]
actual_rows = 1200000000
plan_rows = 0
...
if testing_mode == 1:
    ...
    original_tables_dir = '/Users/joseph/Courses/CSE544/FinalProject/BTS_aviation/'
...
output_dir = '/Users/joseph/Courses/CSE544/FinalProject/results/'

# directory where samples will be written
destination = '/Users/joseph/Courses/CSE544/FinalProject/samples/'
...
def copy_samples(conn, table_names, number_of_files):
    for i in table_names:
        ...
        table_dir = '/Users/joseph/Courses/CSE544/FinalProject/samples/' + i
...
def milestone_report():
    ...
    for method in ['bernoulli','correlated']:
        ...
        # for probability in [0.005, 0.01, 0.015, 0.02, 0.025, 0.05]:
        #     print(method + ' sampling with p=' + str(probability))
        #    sampling_probabilities[1] = probability
